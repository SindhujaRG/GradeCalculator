 ...
 * Present Activity - This activity is the first activity that displays when the user selects the button CSCI240.
 * It contains the quizes 1-12 and the user can enter all the points they secured in each of the quiz
 */
...
public class Cscia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cscia);
 ...
 */
    ...
    public void gotoAssn(View view)
    {
        ...
        Intent IntentAssn = new Intent(Cscia.this, Csciaa.class);
